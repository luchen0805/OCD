...
# For the third plot, I plan to create a pie chart for the distribution of individuals with and without a history of other disorders, to address the research question "Are patients previously diagnosed with other disorders more likely to develop OCD?". And then I will use logistic regression/chi-square test to assess the statistical significance of the association. To create the plot, I will use the Previous diagnoses column to calculate the percentage of individuals in either group. Then, proportion is represented by the area in the chart.
```
